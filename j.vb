' C:\Windows\Microsoft.NET\Framework\v4.0.30319\vbc.exe /langversion:10 .\j.vb
...
Module ProjectEuler
  ...
  Function Solve(ByVal va As Integer) As Long
    Dim la = 0L
    Dim lb = 0
    While lb < va
      lb = lb + If(lb = 2, 1, 2)
      la = la + If(IsPrime(lb), lb, 0L)
    End While
    Return la
  End Function
